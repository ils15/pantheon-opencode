...
function ContextBar(props) {
	...
	const usage = createMemo(() => {
		...
		return {
			tokens,
			limit: ctxLimit > 0 ? ctxLimit : 128e3,
...
function View(props) {
	...
	return (() => {
		var _el$0 = createElement("box"), _el$1 = createElement("text"), _el$10 = createElement("box"), _el$11 = createElement("text"), _el$12 = createElement("text"), _el$15 = createElement("box"), _el$16 = createElement("text"), _el$17 = createElement("text"), _el$19 = createElement("box"), _el$20 = createElement("text"), _el$21 = createElement("text"), _el$23 = createElement("box"), _el$24 = createElement("text"), _el$25 = createElement("box"), _el$26 = createElement("text");
		insertNode(_el$0, _el$1);
		insertNode(_el$0, _el$10);
		insertNode(_el$0, _el$15);
		insertNode(_el$0, _el$19);
		insertNode(_el$0, _el$23);
		insertNode(_el$0, _el$25);
		setProp(_el$0, "flexDirection", "column");
		setProp(_el$0, "width", "100%");
		setProp(_el$1, "attributes", { bold: true });
		insert(_el$1, () => `Pantheon v${props.version}`);
		...
		setProp(_el$10, "onMouseDown", () => setShowSubagents((x) => !x));
		setProp(_el$11, "attributes", { bold: true });
		insert(_el$11, () => `${showSubagents() ? "▼" : "▶"} Subagents`);
		insert(_el$12, () => ` (${String(sessionCount())})`);
		insert(_el$0, createComponent(Show, {
			get when() {
			...
			get children() {
				...
				insert(_el$14, () => `Active sessions: ${String(sessionCount())}`);
		...
		insert(_el$0, createComponent(Show, {
			...
			get children() {
				...
				insert(_el$18, createComponent(For, {
					each: COMMANDS,
					children: (cmd) => (() => {
						var _el$28 = createElement("box"), _el$29 = createElement("text"), _el$30 = createElement("text");
						insertNode(_el$28, _el$29);
						insertNode(_el$28, _el$30);
						setProp(_el$28, "onMouseDown", (e) => {
							e.stopPropagation();
							try {
						...
						insert(_el$29, () => cmd.name);
						insert(_el$30, () => ` \u2014 ${cmd.desc}`);
						effect((_p$) => {
							var _v$10 = cmd.name === "/pantheon" ? theme().accent : theme().textMuted, _v$11 = theme().textMuted;
							_v$10 !== _p$.e && (_p$.e = setProp(_el$29, "fg", _v$10, _p$.e));
							_v$11 !== _p$.t && (_p$.t = setProp(_el$30, "fg", _v$11, _p$.t));
							return _p$;
						}, {
							e: void 0,
							t: void 0
			...
			get children() {
				...
				insert(_el$22, createComponent(For, {
					...
					children: (agent) => (() => {
						...
						insert(_el$32, () => `${agent.tier === "premium" ? "✦ " : "· "}${agent.name}`);
						insert(_el$33, () => ` \u2014 ${agent.role}`);
						effect((_p$) => {
							var _v$12 = agent.tier === "premium" ? theme().accent : theme().textMuted, _v$13 = theme().textMuted;
							_v$12 !== _p$.e && (_p$.e = setProp(_el$32, "fg", _v$12, _p$.e));
							_v$13 !== _p$.t && (_p$.t = setProp(_el$33, "fg", _v$13, _p$.t));
							return _p$;
						}, {
							e: void 0,
							t: void 0
				...
				return createComponent(Show, {
					...
					get fallback() {
						return (() => {
							...
							setProp(_el$34, "marginLeft", 1);
							insertNode(_el$35, createTextNode(`No config data`));
							effect((_$p) => setProp(_el$35, "fg", theme().textMuted, _$p));
							return _el$34;
						})();
					},
					children: (cfg) => (() => {
						var _el$37 = createElement("box"), _el$38 = createElement("text"), _el$39 = createElement("text");
						insertNode(_el$37, _el$38);
						insertNode(_el$37, _el$39);
						setProp(_el$37, "marginLeft", 1);
						setProp(_el$37, "flexDirection", "column");
						insert(_el$38, () => `MCP servers: ${String(cfg().mcpCount)}  Plugins: ${String(cfg().pluginCount)}`);
						insert(_el$39, () => `Auto-compaction: ${cfg().autoCompaction ? "ON" : "OFF"}`);
						effect((_p$) => {
							var _v$14 = theme().textMuted, _v$15 = theme().textMuted;
							_v$14 !== _p$.e && (_p$.e = setProp(_el$38, "fg", _v$14, _p$.e));
							_v$15 !== _p$.t && (_p$.t = setProp(_el$39, "fg", _v$15, _p$.t));
							return _p$;
						}, {
							e: void 0,
							t: void 0
		...
		insert(_el$26, () => `Memory: ${memoryCount() > 0 ? `${fmtInt(memoryCount())} entries` : "0 entries"}`);
		effect((_p$) => {
